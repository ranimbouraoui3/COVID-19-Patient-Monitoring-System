...
# Form implementation generated from reading ui file 'supprimercin.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(0, 0, 821, 611))
        ...
        self.label_2.setGeometry(QtCore.QRect(110, 180, 191, 61))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.lineEdit = QtWidgets.QLineEdit(Dialog)
        self.lineEdit.setGeometry(QtCore.QRect(300, 180, 351, 51))
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Suppression personne donnée"))
        self.pushButton.setText(_translate("Dialog", "supprimer"))
        self.label_2.setText(_translate("Dialog", "N° de CIN :"))
    def getsupprimercin(self):   
